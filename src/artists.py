...
def get_frame_offset(frame_path: str) -> int:
...
def create_img_preview(nft_imgs: List[List[ImgType]], frame_path: str) -> List[ImgType]:
...
def create_nft_preview(nft_imgs: List[List[ImgType]], frame_path: str) -> List[ImgType]:
