...
async def send_join_msg(ctx, username):
    # Configure the message
    embedVar = discord.Embed(
        title=f"Sorry, {username} you're on the Naughty List!",
        description="\
        ...Well more accurately, I don't see you on the Nice List.\n\n\
        Use the !join command to begin receiving gifts this year!\n\n\
        Ho Ho Ho Ho!\
        ",
        color=0xFF0000,
    )
...
async def send_welcome_msg(ctx):
    embedVar = discord.Embed(
        title="HO HO HO HO! MERRY CHRISTMAS! Welcome to the 2024 Discord Advent Calendar!",
        description=f"\
        Every day in the month of December, my elves will make you a special gift:\n\n*A completely unique NFT generated by OpenAI's DALLE-3!*\n\n\
        ...
        With over 14 million possible combinations, there is sure to be something for everyone!!\n\n\
        ...
        *Once you have been added, use the '!claim' or '!create' command to claim your daily gift!*\n\n\
        Use the '!help' or '!faq' commands for more information.\n\n",
        color=0xC54245,
    )
